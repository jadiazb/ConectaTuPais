...
var setContentHeight = function () {
	...
	var bodyHeight = jQuery('#DashContent').outerHeight(),
		footerHeight = jQuery('#DashContent').hasClass('footer_fixed') ? -10 : jQuery('footer').height(),
  ...
  jQuery('#sidebar-menu').find('a').on('click', function(ev) {
	  console.log('clicked - sidebar_menu');
        ...
        if ($li.is('.active')) {
            ...
            {
				if ( jQuery('#DashContent').is( ".nav-sm" ) )
				{
					jQuery('#sidebar-menu').find( "li" ).removeClass( "active active-sm" );
					jQuery('#sidebar-menu').find( "li ul" ).slideUp();
				}
...
jQuery('#menu_toggle').on('click', function() {
		...
		if (jQuery('#DashContent').hasClass('nav-md')) {
	...
	jQuery('#DashContent').toggleClass('nav-md nav-sm');
