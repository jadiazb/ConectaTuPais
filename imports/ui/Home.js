    ...
    render() {
        return (
            <div id='top'>
                ...
                <section id="home" className="s-home target-section" data-parallax="scroll" data-image-src="https://www.bbva.com/wp-content/uploads/en/2016/04/bienvenida-a-colombia-rodero.jpg" data-natural-width='3000' data-natural-height='2000' data-position-y='center'>
                    ...
                    <div className="home-content">
                        ...
                        <div className="row home-content__main">
                            ...
                            <div style={{ height: '150px', width: '5px', position: 'absolute', marginTop: '13px', marginLeft: '-10px', backgroundColor: '#fbd115' }}></div>
                            <h1> Conoce de manera sencilla</h1>
                            <h1> los sistemas de información</h1>
                            <div style={{ height: '55px', width: '5px', position: 'absolute', marginTop: '13px', marginLeft: '-10px', backgroundColor: '#0984e6' }}></div>
                            <h1> de los Ministerios de Colombia</h1>
                            <div style={{ height: '65px', width: '5px', position: 'absolute', marginTop: '13px', marginLeft: '-10px', backgroundColor: '#ce1025' }}></div>
                            <h1> para realizar diferentes procesos.</h1>

                            <div className="home-content__buttons">
                                <a href="/signup" className="smoothscroll btn btn--stroke">
                                    Regístrate
                                </a>
                                <a href="/login" className="smoothscroll btn btn--stroke">
                                    Iniciar Sesión
                                </a>
                    ...
                    <ul className="home-social">
                        <li>
                            <a href="https://facebook.com" target="_blank" style={{ color: '#fbd115' }}><i className="fa fa-facebook" aria-hidden="true" ></i><span>Facebook</span></a>
                        </li>
                        <li>
                            <a href="https://twitter.com" target="_blank" style={{ color: '#0984e6' }}><i className="fa fa-twitter" aria-hidden="true" ></i><span>Twiiter</span></a>
                        </li>
                        <li>
                            <a href="https://instagram.com" target="_blank" style={{ color: '#ce1025' }} ><i className="fa fa-instagram" aria-hidden="true" ></i><span>Instagram</span></a>
                        </li>
                    </ul>
                </section>
                ...
                <section id='services' className="s-services">
                    ...
                    <div className="home-content__scroll">
                            <a href="#works" className="scroll-link smoothscroll">
                                <span>Desplazarse hacia abajo</span>
                            </a>
                        </div>
                    <div className="home-content__line"></div>
                ...
                <footer style={{ backgroundColor: 'black', 'marginLeft': '0px' }}>
                    <div className="row footer-bottom">
                        <div className="col-twelve">
                            <div className="copyright">
                                <span>© Copyright ConectaTuPais 2018</span>
                                <span>Site Template by <a href="https://www.colorlib.com/">Colorlib</a></span>
                            </div>
                            <div className="go-top">
                                <a className="smoothscroll" title="Back to Top" href="#top"><i className="icon-arrow-up" aria-hidden="true">Volver Arriba</i></a>
                            </div>
                        </div>
                    </div>
                </footer>
